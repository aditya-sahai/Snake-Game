...
def DrawGameWindow(win, width, height, bgcolor, snake, snake_size, snake_color, apple_rect, wall_rects):
    win.fill(black)
...
while not game_over:
    ...
    DrawGameWindow(game_window, width, height, black, snake_list, snake_size, green, apple_rect, wall_rects)
